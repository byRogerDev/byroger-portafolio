        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-10 mb-10">
                        ...
                        <div className="mt-10">
                            <dl className="space-y-10 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10 md:space-y-0">
                                ...
                                {props.otherProjects.map((personal: ProfesionalProject, index: number) => (
                                    <ElementCV key={'ElementCV_otherProject_' + index}  name={personal.name} year={personal.year} description={personal.description} techs={personal.technologies} start={personal.start} end={personal.end?personal.end: Date.now()} img={personal.img} gallery={personal.gallery} link={personal.link}></ElementCV>
                                ))}
